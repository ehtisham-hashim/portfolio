...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-md rounded-[2rem] bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] ${stepCircleContainerClassName}`}
...
export function Step({ children }) {
  return <div className="px-8 text-gray-800">{children}</div>;
}
